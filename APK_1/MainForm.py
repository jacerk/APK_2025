...
class Ui_MainWindow(object):
    ...
    def rayCrossingClick(self):
        ...
        results, containing_polygon = algorithms.analyze_point_in_polygons(q, polygons, "ray_crossing")
    ...
    def windingNumberClick(self):
        ...
        results, containing_polygon = algorithms.analyze_point_in_polygons(q, polygons, "winding_number")
